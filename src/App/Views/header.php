...
<body>
    <nav>
        <ul>
            ...
            <li class="<?php echo $menu_item['current_menu_item'] ?>" hx-boost="true"><a href="<?php echo $menu_item['url'] ?>" title="<?php echo $menu_item['name'] ?>"><?php echo $menu_item['name'] ?></a></li>
            <?php endforeach; ?>
            <li><a href="#" title="Backups">Backups</a></li>
